...
<div id="form">
<form name="registration" align="center" class="loginform" action="registration.php" method="post" enctype="multipart/form-data">
<table>
...
<tr><td><label><b>Photo</b></label></td>
		...
		<tr><td><a href="edit.php?ac=<?php echo $row['regid'];?>" class="hov1" name="update">Edit</a></label></td>
		<tr><td><a href="deleteprofile.php?ac=<?php echo $row['regid'];?>" class="hov1" name="update">Delete</a></label></td>
